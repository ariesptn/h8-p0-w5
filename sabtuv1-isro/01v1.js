...
NOTE: 
Tidak masalah jika 0 detik ditampilkan.
WAJIB MENGGUNAKAN PSEUDOCODE
TIDAK BOLEH MENGGUNAKAN LOOPING
HINT: HANYA GUNAKAN IF-ELSE/SWITCH-CASE
*/
...
function formatDuration(seconds) {
  if (seconds < 60) {
    ...
    return Math.floor(seconds / 60) + ' menit ' + formatDuration(seconds % 60);
  } else {
    return Math.floor(seconds / 3600) + ' jam ' + formatDuration(seconds % 3600);
  }
}

console.log(formatDuration(3660)); // 1 jam 1 menit 0 detik
console.log(formatDuration(62)); // 1 menit 2 detik
console.log(formatDuration(7324)); // 2 jam 2 menit 4 detik
console.log(formatDuration(0)); // 0 detik